...
path1 = 'E:/5_Fruit_Disease_Detection/Dataset - Copy (2)/test_set/Pomegranate-Normal'    #path of folder of images    
path2 = 'E:/5_Fruit_Disease_Detection/Dataset/test_set/23'  #path of folder to save images    
