...
#
lbl = tk.Label(root, text="prediction of fruit disease with recommended fertilizer", font=('times', 35,' bold '), height=1, width=42,bg="yellow",fg="Black")
