...
root.title("fruit and vegetables detection ")
...
# img2=ImageTk.PhotoImage(Image.open("bg1.jpg"))

# img3=ImageTk.PhotoImage(Image.open("bg2.jpg"))
...
#
label_l1 = tk.Label(root, text="Fruit And Vegetable Disease Detection Using Machine Learning",font=("Times New Roman", 30, 'bold'),
...
def fruit():
    from subprocess import call
    call(["python","GUI_Master_fruit.py"])
...
button1 = tk.Button(root, text="Fruit Disease detection ", command=fruit, height=1,font=('times', 20, ' bold '), bg="#152238", fg="white")
button1.place(x=100, y=160)

button2 = tk.Button(root, text="Vegetable Disease detection",command=veg, height=1,font=('times', 20, ' bold '), bg="#152238", fg="white")
